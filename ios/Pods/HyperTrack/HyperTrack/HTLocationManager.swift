...
extension LocationManager: CLLocationManagerDelegate {
                        ...
                        if let circularRegion = monitoringRegion as? CLCircularRegion{
                            if(circularRegion.contains(clLocation.coordinate)){
                                if circularRegion.notifyOnEntry {
                                    ...
                                    NotificationCenter.default.post(name:Notification.Name(rawValue:HTConstants.HTActionIsNearCompletionNotification),
                                                                    object: nil,
                                                                    userInfo: nil)
    ...
    public func locationManager(_ manager: CLLocationManager, didEnterRegion region: CLRegion){
        ...
        NotificationCenter.default.post(name: Notification.Name(rawValue:HTConstants.HTMonitoredRegionEntered),
                                        object: nil,
