...
public struct HTConstants {
   ...
   static let HTStopStartedNotification = "HTStopStartedNotification"
   static let HTStopEndedNotification = "HTStopEndedNotification"
   static let HTActionCreatedNotification = "HTActionCreatedNotification"
   static let HTActionIsNearCompletionNotification = "HTActionIsNearCompletionNotification"
