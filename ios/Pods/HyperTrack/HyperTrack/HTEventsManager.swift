...
extension EventsManager {
    ...
    func saveStopEnded(location:CLLocation, recordedAt:Date, stopId: String, stepCount:Int?, stepDistance:Int?) {
        ...
        nc.post(name:Notification.Name(rawValue:HTConstants.HTStopEndedNotification),
                object: nil,
                userInfo: nil)
    }
    ...
    func saveStopStarted(location:CLLocation, recordedAt:Date) {
        ...
        let nc = NotificationCenter.default
        nc.post(name:Notification.Name(rawValue:HTConstants.HTStopStartedNotification),
                object: nil,
                userInfo: nil)
    }
